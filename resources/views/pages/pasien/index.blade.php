    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                ...
                @else
                <h3>Data Pasien Gedung {{$gedung}}</h3>
                @endif
            ...
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item active"><a href="/pasien">Data Pasien</a></li>
                    </ol>
                </nav>
            </div>
        </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <a href="{{ route('rekam-medis', $data->id) }}" class="btn btn-sm btn-warning" data-bs-toggle="tooltip"
