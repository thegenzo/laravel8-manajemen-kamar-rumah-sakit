...
@section('title', 'Data Antrian Pasien')
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item active"><a href="/antrian">Data Antrian Pasien</a></li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <section class="section">
        <div class="card">
            <div class="card-header">
                ...
                <a href="{{ route('antrian.create') }}" class="btn btn-primary float-right mb-2">Tambah Antrian Pasien</a>
                @endif
            </div>
            <div class="card-body">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{{ route('antrian.edit', $data->id) }}" class="btn btn-sm btn-warning" data-bs-toggle="tooltip"
                                ...
                                <form action="{{ route('antrian.destroy', $data->id) }}" method="POST" class="d-inline swal-confirm">
                                    ...
                                    <button class="btn btn-sm btn-danger swal-confirm" type="submit" data-id="{{ $data->id }}" data-bs-toggle="tooltip"
                                        data-bs-placement="bottom" title="Hapus Antrian">
