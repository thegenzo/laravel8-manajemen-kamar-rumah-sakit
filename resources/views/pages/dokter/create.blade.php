    ...
    <section class="section">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Masukkan data dokter</h4>
            </div>
            <div class="card-body">
                @if (count($errors) > 0)
                        ...
                        <div class="col-md-12">
                            <div class="form-group row align-items-center">
                                ...
                                <div class="col-lg-10 col-9">
                                    <input type="text" id="nama_dokter" class="form-control" name="nama_dokter" placeholder="Masukkan Nama Dokter">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group row align-items-center">
                                ...
                                <div class="col-lg-10 col-9">
                                    <input type="text" id="spesialis" class="form-control" name="spesialis" placeholder="Masukkan Spesialis">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group row align-items-center">
                                ...
                                <div class="col-lg-10 col-9">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="jadwal" class="form-control" name="jadwal" placeholder="Masukkan Jadwal">
                                    </div>
                                </div>
                            </div>
                        </div>
