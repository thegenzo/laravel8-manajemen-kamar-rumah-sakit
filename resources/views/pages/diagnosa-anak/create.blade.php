...
@section('title', 'Diagnosa Pasien Anak')
    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Diagnosa Pasien Anak</h3>
            </div>
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="/pasien">Data Pasien Anak</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Diagnosa Pasien Anak</li>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form action="/diagnosa-anak/{{ $pasien->id }}" method="POST">
                            @csrf
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group row align-items-center">
