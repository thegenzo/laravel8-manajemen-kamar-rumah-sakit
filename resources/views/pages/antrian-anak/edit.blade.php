...
@section('title', 'Kirim Pasien Anak ke Kamar Inap')
    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Kirim Pasien Anak ke Kamar Inap</h3>
            </div>
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="/pasien">Data Pasien Anak</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Kirim Pasien Anak ke Kamar Inap</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <section class="section">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Kirim Pasien Anak ke Kamar Inap</h4>
            </div>
            <div class="card-body">
                @if (count($errors) > 0)
                ...
                @endif
                <form action="{{ route('antrian-anak.update', $antrian->id) }}" method="POST">
                    @method('PUT')
                    @csrf
                    <div class="row">
                        <div class="col-md-12">
