...
@section('title', 'Tambah Antrian Pasien Anak')
    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Tambah Antrian Pasien Anak</h3>
            </div>
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="/pasien">Data Pasien</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Tambah Antrian Pasien Anak</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <section class="section">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Masukkan data antrian pasien anak</h4>
            </div>
            <div class="card-body">
                @if (count($errors) > 0)
                ...
                @endif
                <form action="{{ route('antrian-anak.store') }}" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-md-12">
                    ...
                    <a href="/antrian-anak" class="btn btn-warning d-inline">Kembali</a>
